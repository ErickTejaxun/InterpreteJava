...
public class dibujador 
{
    ...
    public String dibujarInterfaz(NodoReporte raiz, int numero)
    {
        String retorno="";
        if(raiz!=null)
        {
            ...
            switch(raiz.getValue())
            {
                case "DOCUMENTO":
                    retorno = "package Principal;\n" +
                                    ...
                                    "    {\n";
                    for(NodoReporte aux: raiz.getHijos())
                    {
    ...
    public void imprimirtodo(NodoReporte raiz, int numero) throws FileNotFoundException
    {        
    ...
    public String todo(NodoReporte raiz)
    {
        String cadena = "";
