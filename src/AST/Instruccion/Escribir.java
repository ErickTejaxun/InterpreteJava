 ...
 * @author erick
 */
public class Escribir implements Instruccion, Runnable
{
    ...
    public Escribir(ArrayList<Nodo> list, int l, int c)
    {
        ...
        for(Nodo nodo: instrucciones)
        {
            try 
            {
                ...
                if(nodo instanceof Instruccion)
                {
                    ...
                    if(nodo instanceof Escribir)
                    {
                        local = new Entorno(global, global.ventana);
                        return ((Escribir)nodo).ejectuar(local);                    
                    }
