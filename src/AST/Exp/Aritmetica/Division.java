...
public class Division implements Expresion
{
    ...
    public Object valor;
    public Division(Expresion i, Expresion d, int l, int c)
    {
        this.operadori = i;
        this.operadord = d;
        this.linea = l;
    ...
    public Object getValor(Entorno ent) 
    {
        ...
        switch(operadord.getTipo().typeprimitive)
        {
            ...
            case DOUBLE:
                if((int)valord == 0)
                {
                    Utilidades.Singlenton.registrarError("División", "División sobre cero no está definida. ", ErrorC.TipoError.SEMANTICO, linea, linea);
                    return valori;
                }                
                break;
            case CHAR:
